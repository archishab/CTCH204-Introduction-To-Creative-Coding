 ...
 * Course: CTCH 204 - Project 2
 * Description: Arduino code for a digital pet dino game
 * References: https://projecthub.arduino.cc/garyz-hk/a-real-tamagotchi-emulator-for-arduino-uno-d84435
 */
...
Adafruit_SSD1306 display(OLED_RESET); // Create an OLED display object

const int button1Pin = 9; // Pin number for button 1
const int button2Pin = 8; // Pin number for button 2
const int button3Pin = 7; // Pin number for button 3

const int sound = 6; // Pin number for sound output
...
// Sprite data for the front grass (32x10)
...
// Sprite data for the regular grass where dino walks (4x8)
const unsigned char grass [] PROGMEM = {
0xff, 0xee, 0xbb, 0x55, 0xaa, 0x11, 
};

// Sprite data for trees
...
// Sprites data for the dino game
...
void setup() {
  ...
  display.print(F("CTCH 204 Project 2\n"));
